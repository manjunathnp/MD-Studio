...
The HTML embeds its logo, favicon, styles, and scripts. Downloading the HTML alone is enough; no assets folder is required. Remote images or links in your Markdown may still require internet access.
